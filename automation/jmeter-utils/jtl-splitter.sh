...
java -Xms${heap_size} -Xmx${heap_size}  -jar /Users/mohamedsabthar/Desktop/sabthars-territory/automation/jmeter-utils/jtl-splitter-0.4.6-SNAPSHOT.jar $jtl_splitter_flags